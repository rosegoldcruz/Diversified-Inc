...
export const mockSops: Sop[] = [
  {
    ...
    description:
      "Step-by-step onboarding process for new hires including account setup, compliance forms, role training, and first-week assignment handoff.",
    category: "HR / Employee",
    department: "People Operations",
    owner: "Cathy Reynolds",
    status: "Active",
    lastUpdated: "2026-04-30",
    reviewDate: "2026-07-31",
    relatedFileIds: ["DOC-001"],
    relatedFormIds: ["FORM-HR-ONBOARD"],
    relatedTaskIds: ["TASK-ONBOARD-01", "TASK-ONBOARD-02"],
  },
  {
    id: "SOP-002",
    title: "Work Order Intake Process",
    description:
      "Defines how office staff validates incoming work order requests, confirms required fields, assigns priority, and routes to operations review.",
    ...
    relatedFormIds: ["WO-REQUEST"],
    relatedTaskIds: ["TASK-WO-INTAKE"],
    relatedWorkOrderIds: ["WO-8801", "WO-8802"],
  },
  {
    id: "SOP-003",
    title: "Inventory Reorder Procedure",
    description:
      "Standard threshold-based reorder workflow for operational materials including stock check, supplier quote comparison, and approval routing.",
    category: "Inventory",
    department: "Purchasing",
    owner: "Terry Mitchell",
    status: "Needs Review",
    lastUpdated: "2026-04-21",
    reviewDate: "2026-05-20",
    relatedTaskIds: ["TASK-INV-REORDER"],
    relatedFormIds: ["PO-REQUEST"],
  },
  {
    id: "SOP-004",
    title: "Time Off Request Procedure",
    description:
      "Documents submission windows, manager approval steps, conflict checks, and payroll notification requirements for employee time-off requests.",
    category: "HR / Employee",
    department: "People Operations",
    owner: "Jill Anderson",
    status: "Active",
    lastUpdated: "2026-05-06",
    relatedFormIds: ["TIME-OFF-REQUEST"],
    relatedTaskIds: ["TASK-HR-APPROVAL"],
  },
  {
    id: "SOP-005",
    title: "File Upload Naming Standard",
    description:
      "Required naming convention for uploaded operational files to ensure quick retrieval by work order, customer, date, and document type.",
    ...
    relatedFileIds: ["DOC-003", "DOC-006"],
  },
  {
    id: "SOP-006",
    title: "End-of-Day Task Update Procedure",
    description:
      "Checklist for team members to update task status, blockers, and next actions before close of business for leadership visibility.",
    category: "Office Procedures",
    department: "Operations",
    owner: "Jordan Taylor",
    status: "Active",
    lastUpdated: "2026-05-01",
    relatedTaskIds: ["TASK-EOD-REVIEW"],
  },
  {
    id: "SOP-007",
    title: "Escalating Blocked Work",
    description:
      "Escalation path for blocked tasks and stalled work orders including notification timing, accountability owner, and leadership escalation rules.",
    ...
    relatedTaskIds: ["TASK-BLOCKED-ESCALATION"],
    relatedWorkOrderIds: ["WO-8802"],
  },
  {
    id: "SOP-008",
    title: "Weekly Leadership Report Prep",
    description:
      "Friday reporting process for compiling completed work, overdue items, open requests, and risks for leadership review.",
    category: "Billing / Admin",
    department: "Leadership",
    owner: "Jill Anderson",
    status: "Archived",
    lastUpdated: "2026-03-29",
    relatedFileIds: ["DOC-007"],
    relatedTaskIds: ["TASK-WEEKLY-REPORT"],
  },
];
