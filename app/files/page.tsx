...
const MOCK_FILES = [
  { id: "F-001", name: "emma-castillo-contract.pdf", type: "contract", jobId: "WO-2041", size: "142 KB", uploadedAt: "2025-05-02" },
  { id: "F-002", name: "james-park-qc-before.jpg", type: "photo", jobId: "WO-2038", size: "3.2 MB", uploadedAt: "2025-05-06" },
  { id: "F-003", name: "james-park-qc-after.jpg", type: "photo", jobId: "WO-2038", size: "2.9 MB", uploadedAt: "2025-05-07" },
  { id: "F-004", name: "tony-nguyen-quote-v2.pdf", type: "document", jobId: "WO-2044", size: "88 KB", uploadedAt: "2025-05-05" },
  { id: "F-005", name: "permit-AZ48821-alvarez.pdf", type: "permit", jobId: "WO-2050", size: "210 KB", uploadedAt: "2025-05-03" },
  { id: "F-006", name: "supplier-manifest-az-cab.xlsx", type: "document", jobId: "—", size: "54 KB", uploadedAt: "2025-05-04" },
  { id: "F-007", name: "wilson-qc-photos.zip", type: "archive", jobId: "WO-2033", size: "18.4 MB", uploadedAt: "2025-05-06" },
  { id: "F-008", name: "rachel-kim-vanity-contract.pdf", type: "contract", jobId: "WO-2029", size: "136 KB", uploadedAt: "2025-05-05" },
];
